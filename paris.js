...
function initMap() {
    ...
    // 1. Fond de carte satellite haute résolution (Esri World Imagery)
    L.tileLayer("https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}", {
        attribution: "Tiles &copy; Esri, Earthstar Geographics",
        maxZoom: 19
    }).addTo(map);

    // 2. Calque transparent des noms de rues et frontières pour le repérage
...
function afficherResultats(data) {
    ...
    color: "#ffffff",     // Bordure blanche pour contraster avec le sol
    weight: 2,
    opacity: 1,
    fillOpacity: 0.95
        });
